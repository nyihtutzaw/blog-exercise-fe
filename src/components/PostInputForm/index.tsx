...
import { Button, TextBox, ErrorContainer, RichTextEditor } from '@/components';
        ...
        <div className="w-full p-6 mt-4 bg-white rounded-lg shadow-lg">
            ...
            <form onSubmit={handleSubmitHandler(handleSubmit)}>
                ...
                <div className="mb-4">
                    <Button type="submit"
                        loading={allLoading}
                        className="w-full flex items-center justify-center bg-primary text-white py-2 px-4 rounded-md hover:bg-primary hover:text-secondary focus:outline-none">Save</Button>
                </div>

                {
                    editPost && <Button type="button"
                        onClick={() => deletePost(editPost.id)}
                        loading={allLoading}
                        className="w-200 flex items-center justify-center bg-red-500 text-white py-2 px-4 rounded-md hover:bg-primary hover:text-secondary focus:outline-none">Delete</Button>
                }
